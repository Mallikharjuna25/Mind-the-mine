...
from backend.app.models.module2_models import IncidentRecord, FieldVerification
from backend.app.schemas.module2_schemas import IncidentRecordCreate, IncidentRecordResponse
...
def get_incident_by_id(incident_id: str, db: Session = Depends(get_db), current_user: dict = Depends(get_current_user)):
