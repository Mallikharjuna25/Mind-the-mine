...
from app.models.module2_models import FieldReport
from app.schemas.module2_schemas import FieldReportCreate, FieldReportResponse
...
def get_field_report_by_id(report_id: str, db: Session = Depends(get_sync_db), current_user: dict = Depends(get_current_user)):
